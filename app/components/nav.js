    ...
    <>
      <nav className="bg-black fixed w-screen z-50">
        <div className=" w-screen-xl flex flex-row  justify-between mx-5 p-1">
          ...
          <Link className=" w-24" href="/"> <span className="w-auto h-auto"> <Image className=" w-full relative hover:-right-2" src="/assets/images/sv - logo con fondo negro.png" width={1000} height={1000} /> </span></Link>
            ...
            <ul className=" font-medium flex flex-col p-4 mt-4  rounded-lg bg-black lg:p-0 lg:flex-row lg:space-x-8 md:mt-0 lg:border-0 ">
              ...
              <li className="mt-10 lg:mt-6">
                <Link className="text-sm w-44 flex text-white hover:text-amber-400 justify-between" href="#" onClick={() => setIsSubOpen(!isSubOpen)}> SUPLEMENTOS 
                    <span > <Image className={` w-2 h-4 invert ${isSubOpen && "subOpen"}`} src="/assets/images/arrow.ico" width={1000} height={1000} /></span>
                </Link>
                <div className={` subnav_items ${isSubOpen && "subOpen"}`}>
                  <ul className="subnav">
                    <li className=" flex hover:bg-gradient-to-r from-black to-white/50 rounded-r-lg">
                      <Link className=" texto w-1/2 ml-10 text-sm text-white hover:text-amber-400 hover:relative hover:py-14 hover:text-lg" href="/productos"> AMINOACIDOS </Link>
                      <Image className=" img w-40 " src="/assets/images/SV_PRODUCTOS_aminoacidos_2.png" width={1000} height={1000} />
                    </li>
                    <li className=" flex hover:bg-gradient-to-r from-black to-white/50 rounded-r-lg">
                      <Link className="texto w-1/2 ml-10 text-sm text-white hover:text-amber-400 hover:relative hover:py-14 hover:text-lg" href="/productos"> COOPER </Link>
                      <Image className=" img w-40 " src="/assets/images/SV_PRODUCTOS_cooper_2.png" width={1000} height={1000} />
                    </li>
                    <li className=" flex hover:bg-gradient-to-r from-black to-white/50 rounded-r-lg">
                      <Link className="texto w-1/2 ml-10 text-sm text-white hover:text-amber-400 hover:relative hover:py-14 hover:text-lg" href="/productos"> GANADORES DE PESO </Link>
                      <Image className=" img w-40 " src="/assets/images/SV_PRODUCTOS_creadores_de_peso.png" width={1000} height={1000} />
                    </li>
                    <li className=" flex hover:bg-gradient-to-r from-black to-white/50 rounded-r-lg">
                      <Link className="texto w-1/2 ml-10 text-sm text-white hover:text-amber-400 hover:relative hover:py-14 hover:text-lg" href="/productos"> CREATINAS </Link>
                      <Image className=" img w-40 " src="/assets/images/SV_PRODUCTOS_creatinas.png" width={1000} height={1000} />
                    </li>
                    <li className=" flex hover:bg-gradient-to-r from-black to-white/50 rounded-r-lg">
              ...
              <li className=" flex mt-10 lg:mt-5">
                ...
                <Link className=" mx-1 m-0 lg:w-auto " href="https://www.instagram.com/suplementosvenezuelaoficial/" target="_blank"> <span className="w-auto h-auto"> <Image className=" w-6 h-6 rounded-full  hover:w-7 hover:h-7 invert" src="/assets/images/instagram_black.ico" width={1000} height={1000} /> </span> </Link>
                <Link className=" mx-1 m-0 lg:w-auto " href="https://www.youtube.com/@suplementosvenezuela5294" target="_blank"> <span className="w-auto h-auto"> <Image className=" w-6 h-6 rounded-full  hover:w-7 hover:h-7 invert" src="/assets/images/youtube_black.ico" width={1000} height={1000} /> </span> </Link>
              </li>
